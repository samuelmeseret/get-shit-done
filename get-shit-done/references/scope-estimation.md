...
<quality_insight>
Codex degrades when it *perceives* context pressure and enters "completion mode."
...
**The 40-50% inflection point:** Codex sees context mounting and thinks "I'd better conserve now." Result: "I'll complete the remaining tasks more concisely" = quality crash.
...
**Commit rule:** Each plan produces 3-4 commits total (2-3 task commits + 1 docs commit). More granular history = better observability for Codex.
</summary>
</scope_estimation>
