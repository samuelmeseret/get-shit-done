...
Triggered by /gsd:research-phase command when the domain is niche, complex, or Codex's training is likely stale.
...
<when_to_use>
**This workflow is for domains where Codex fails without research:**
...
- Specialized frameworks with active ecosystems Codex may not know
...
- What's SOTA vs what Codex thinks is SOTA?
...
- What version is current? (Codex's training may be stale)
...
Codex's training data is 6-18 months stale. Treat pre-existing knowledge as hypothesis, not fact.
...
- Key changes since [Codex's training]: [from docs/WebSearch]
...
**From ~/.codex/get-shit-done/references/research-pitfalls.md:**
...
- [ ] Checked for libraries Codex might not know about
...
Use template from ~/.codex/get-shit-done/templates/research.md
...
This produces higher quality plans because Codex knows:
